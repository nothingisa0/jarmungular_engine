...
impl VulkanApp {
    ...
    pub fn init_vulkan(window: &Window) -> VulkanApp {
        ...
        //Get extensions from ash::khr (defined up at the top, might move it into a new file later)
    ...
    fn create_logical_device(instance: &ash::Instance, physical_device: vk::PhysicalDevice, surface_req: &SurfaceReq, validation: Vec<*const i8>) -> (ash::Device, vk::Queue, vk::Queue) {
        ...
        let queue_priorities = [1.0_f32]; //There will be one for each queue being created from the queue family
    ...
    fn create_surface(entry: &ash::Entry, instance: &ash::Instance, window: &Window) -> SurfaceReq {
        ...
        let surface_loader_win32 = ash::khr::win32_surface::Instance::new(entry, instance);
    ...
    fn create_swapchain(instance: &ash::Instance, device: &ash::Device, physical_device: vk::PhysicalDevice, surface_req: &SurfaceReq) -> SwapchainReq {
        ...
        let swapchain_info = vk::SwapchainCreateInfoKHR {
            ...
            image_usage: vk::ImageUsageFlags::COLOR_ATTACHMENT, //This defines what the swapchain images will be used for. Swapchain is being directly rendered to.
            image_sharing_mode,
            queue_family_index_count,
            p_queue_family_indices: queue_family_indices.as_ptr(),
            pre_transform: swapchain_support_details.capabilities.current_transform,
            composite_alpha: vk::CompositeAlphaFlagsKHR::OPAQUE, //Used for blending between different windows. Don't want that, just make opaque
            present_mode,
